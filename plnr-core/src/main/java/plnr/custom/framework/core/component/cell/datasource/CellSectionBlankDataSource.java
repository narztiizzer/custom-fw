 ...
 */
public class CellSectionBlankDataSource extends BaseCellDataSource {

    public static String TAG = "core.framework.CellSectionBlank";
     ...
     * @param tag        Tag
     */
    public CellSectionBlankDataSource(BaseModel dataObject, String tag) {
